...
const App = () => {
  ...
  // Handle search submission - FIXED: Use Geocoding API
  ...
  // Handle suggestion selection - FIXED: Properly update input, location, map, and fetch places
    ...
    <Router>
      <div className={`app ${theme}`}>
        ...
        <div className="main-content">
          ...
          {/* Main Search Section - FIXED LAYOUT */}
