...
const App = () => {
  ...
  // Validate API key - FIXED: Check for missing or placeholder keys
  useEffect(() => {
    ...
    try {
      ...
      if (searchInputRef.current && !autocompleteRef.current) {
        ...
        try {
          ...
          setMapsError('Places API autocomplete failed. Please ensure Places API is enabled.');
        }
      }
  ...
  }, [googleMapsLoaded, currentLocation, theme, mapInitialized, mapsError, selectedMood, selectedDistance]);
  ...
  const handleSearch = useCallback((query) => {
    ...
    if (lowerQuery.includes('near me') || lowerQuery.includes('near')) {
      ...
      // Use Places Autocomplete for location search
      try {
        ...
        setError('Search functionality requires Places API to be enabled.');
      }
    }
          ...
          <div className="location-search-section">
            ...
            <div className="enhanced-search-container">
              ...
              <div className="search-examples">
                <span>Try:</span>
                <button onClick={() => handleSearch('cafe near me')} className="example-btn" disabled={!!mapsError}>cafe near me</button>
                <button onClick={() => handleSearch('gym in Delhi')} className="example-btn" disabled={!!mapsError}>gym in Delhi</button>
                <button onClick={() => handleSearch('restaurants near Connaught Place')} className="example-btn" disabled={!!mapsError}>restaurants near Connaught Place</button>
              </div>
            </div>
          </div>
